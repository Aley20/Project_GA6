...
%token <string> STRING
%token <string> VAR
%token IMPRIME SI ALORS VAVERS ENTREE FIN REM NL SOUSROUTINE RETOURNE
...
instr:
  ...
  | NL { Newline }
  | SOUSROUTINE expr { Subroutine $2 } (* Ajout pour l'extension 3 *)
  | RETOURNE { Return } (* Idem *)
...
expr:
  ...
  | NOT expr { Binop (Num 0, "-", $2) }  (* Unary minus *)
